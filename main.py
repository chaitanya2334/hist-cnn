...
def build_model(dataset, cfg):
    ...
    model = torchvision.models.inception_v3(pretrained=cfg['PRETRAIN'])
    ...
    if cfg['PRETRAIN']:
        ...
        model.fc = nn.Linear(2048, cfg['NUM_LABELS'])
        optimizer = optim.Adadelta(model.fc.parameters(), lr=cfg['LEARNING_RATE'], weight_decay=cfg['L2_REG'])
        print("Done")
